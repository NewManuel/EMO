...
2. Make sure to rename the `.env.example` file to `.env` and fill in the environment variables.

3. Confirm that the MySQL server is turned on.

4. Run `CREATE DATABASE dish_db;` to create a new database.

5. Return to your console and run `node seeds/index.js` to seed the database.
